...
class NELQAnalyser implements ServicesInterface {
	...
	private function checkLanguage(Question $post) {
		...
		$langKeywords = [
			'es' => '\bcodigos?\b|\bpero\b|resultado|\bc(?:o|ó)mo\b|\bHola\b|tengo|\bcomo\b|ayud(?:a|r?eme)|est(?:oy|á|e)|Buenos|SALUDO|vamos|Gracias|nuevo|\bAQUI\b|por adelantado|anticipación|¿|¡|\bpued(?:o|a)\b|aplicación|solución|función|espero|alguien|\buna\b|siguiente|Alguna|sugerencia|selección|Tenemos|llamar|palabra|Cómo|codifcar|podria|mucho|Queremos|tiempo|haciendo|\bparar\b|usuario|número|\bdatos\b|de dato|el tipo|código|\bmuy\b|\bestoy?\b|encontré|\bobjeto\b|había|\bentrar\b|\bque\b|\bpude\b|ustedes|algunos?|puedo|puede|saber|necesito|nombre|resolver|hacer|salida|celdas',
			'pt' => 'boa tarde|ajude|\btodas\b|\bvoc(?:ê|e)\b|\best(?:á|a)\b|estão|\bcomo\b|vamos|\bestou\b|minha|quando|então|tenho|\bquero\b|\bquem\b|porque|obrigad(?:a|o)|\bJá\b|\bTento\b|\berro\b|(?:de )?dados|\bfunciona\b|Olá|resultou|RESULTADO|Alguma|linha|antecipadamente|dúvida|minha|aplicação|versão|\bpagina\b|\bdois\b|Sou novo|\bnão\b|\bpassar\b|têm|\bparar\b|código|\bfazer\b|\btoda\b|senha|conseguir|será|Alguém|dificuldade|informações|planilha|tentei|abaixo|\bcodigo\b',
			...
			'it' => 'per favore|\baiuto\b|aiutami|Buon\hgiorno|buona serata|io ho|domanda|\bpagina\b|soluzione|tutt(?:i|o)|lo stesso|salve|Grazie|provato|cercando|funziona|questo|messaggi|di errore|l\'errore|codice|quando|usare|più|\bche\b|aiuto|quanto|bisogno|linguaggio|colonne|possa|partire|nell\'|\bl\'|senza|se hai|\bho\b', // italian
			'th' => '\p{Thai}{3,}',
